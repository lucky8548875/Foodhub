...
import com.hilagangluzon.foodhub.Admin.CollectionSelectActivity;
        ...
        for(DocumentSnapshot document : snapshots)
        {
            ...
            if(enteredUser.equals(queriedUser) && enteredPass.equals(queriedPass))
            {
                ...
                if(document.getBoolean("is_admin"))
                {
                    ...
                    //CollectionSelectActivity.loggedInUserId = document.getId();
                ...
                else
                {
                    ...
                    Dashboard.loggedInUserId = document.getId();
                    Dashboard.loggedInUserInfo = document.toObject(User.class);
                    finish();
                }
